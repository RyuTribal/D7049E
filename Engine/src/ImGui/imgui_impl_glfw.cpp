...
static void ImGui_ImplGlfw_UpdateKeyModifiers(GLFWwindow* window)
{
    ...
    io.AddKeyEvent(ImGuiMod_Ctrl,  (Engine::Input::IsKeyPressed(GLFW_KEY_LEFT_CONTROL))      ||	(Engine::Input::IsKeyPressed(GLFW_KEY_RIGHT_CONTROL))); // If it goes through our system it works
    io.AddKeyEvent(ImGuiMod_Shift, (Engine::Input::IsKeyPressed(GLFW_KEY_LEFT_SHIFT))		 || (Engine::Input::IsKeyPressed(GLFW_KEY_RIGHT_SHIFT)));
    io.AddKeyEvent(ImGuiMod_Alt,   (Engine::Input::IsKeyPressed(GLFW_KEY_LEFT_ALT))			 || (Engine::Input::IsKeyPressed(GLFW_KEY_RIGHT_ALT)));
    io.AddKeyEvent(ImGuiMod_Super, (Engine::Input::IsKeyPressed(GLFW_KEY_LEFT_SUPER))		 || (Engine::Input::IsKeyPressed(GLFW_KEY_RIGHT_SUPER)));
}
